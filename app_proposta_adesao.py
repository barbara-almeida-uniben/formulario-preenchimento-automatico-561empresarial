...
def gerar_proposta(
    ...
    can.drawString(35, 250, str(row["NUMERO"]))
    can.drawString(145, 245, str(row["COMPLEMENTO"]))
    can.drawString(300, 250, str(row["BAIRRO"]))
    can.drawString(35, 215, str(row["CIDADE"]))
    can.drawString(385, 215, somente_digitos(row["CEP"], 8))
